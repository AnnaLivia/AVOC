#ifndef ANTICLUSTERING_CONFIG_PARAMS_H
#define ANTICLUSTERING_CONFIG_PARAMS_H
...
extern const char *init_path;

// log and result path
extern std::string inst_name;
...
#endif //ANTICLUSTERING_CONFIG_PARAMS_H
